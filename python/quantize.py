...
if __name__ == "__main__":
    ...
    # [move_src][move_dst][promo_piece_type else 6]
    ...
    def get_move_idx(move_, piece_type):
    ...
    def get_value_and_policy(fen_):
        ...
        for move in board_oriented.legal_moves:
            ...
            legal_moves_idxs_tensor[0][get_move_idx(move, pt)] = True

        pred_value, pred_logits = net.forward(
            stm_features_tensor, ntm_features_tensor, legal_moves_idxs_tensor
        )
        ...
        for move in board.legal_moves:
            ...
            move_idx = get_move_idx(oriented_move, pt)

            logit = float(pred_logits[move_idx].detach())
            move_policy = float(pred_policy[move_idx].detach())
